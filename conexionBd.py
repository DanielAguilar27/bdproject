...
class Registro_datos():
    ...
    def __init__(self):
        self.conexion = mysql.connector.connect( host='localhost',
                                            database ='proyectofbd', 
                                            user = 'root',
                                            password ='')



    def inserta_donacion(self,codigo, nombre, modelo, precio, cantidad):
        cur = self.conexion.cursor()
        sql='''INSERT INTO productos (Concepto DMT, Concepto DSI, Ref_Resolucion, PRECIO, CANTIDAD) 
